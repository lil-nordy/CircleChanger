...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        # self.y = y
        # self.radius = radius
        # # The following code is redundant because the stuff on the right is assinged to the stuff on the left,
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        # Other organization
        # r_index = random.randrange(len(self.colors))
        # r_color = self.colors[r_index]
    ...
    def swallow(self, other_circle_changer):
        ...
        What goes out:
          -- Returns a new CircleChanger:
             ...
             -- whose tuple of colors *is* *spelling*a new tuple
    ...
    def change_to_next_color_in_tuple(self):
        ...
        Side effects:
          ...
          -- Each time therafter *thereafter* *spelling* that this method is called, this
        ...
        ################################################################
        self.current_color += 1
        self.circle.fill_color = self.colors[self.current_color % len(self.colors)]
